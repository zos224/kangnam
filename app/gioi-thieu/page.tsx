...
import CampaignSection from "./CampainSection";
...
export default function About() {
  const { introduce, loading } = useIntroduceData();
  return (
    introduce && 
    <div className="flex flex-col min-h-screen">
      ...
      {loading ? (
        ...
        <>
          <AboutUs introduce={introduce}/>
          <ServiceSlider/>
          <BannerSection/>
          <CampaignSection  introduce={introduce}/>
          <NewsSource  introduce={introduce}/>
          <NewsCustomer  introduce={introduce}/>
        </>
      )}
