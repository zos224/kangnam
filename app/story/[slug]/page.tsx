...
import DoctorTeams from "@/app/doi-ngu-bac-si/page";
import { useStoryDetailData } from "@/hooks/useStoryDetailData";

export default function StoryDetailPage({params}: {params: Promise<{slug: string}>}) {
  const paramData = use(params);
  const {story, loading } = useStoryDetailData({ slug: paramData.slug });
  return (
